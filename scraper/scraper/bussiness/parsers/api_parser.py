...
class APIParser:
    ...
    def parse_bidding(self, json_str: str) -> dict:
        ...
        bidding_doc = {
            ...
            'nombreResponsableContrato': bidding_data['NombreResponsableContrato'],
            'emailResponsableContrato': bidding_data['EmailResponsableContrato'],
            'fonoResponsableContrato': bidding_data['FonoResponsableContrato'],
            'fecha': bidding_data['Adjudicacion']['Fecha'],
            'numero': bidding_data['Adjudicacion']['Numero'],
            'numeroOferentes': bidding_data['Adjudicacion']['NumeroOferentes'],
